...
<SlideIn as="section" direction="zoom-in" className="section">
        <div className="container">
          <SectionTitle
            title="What is Contractor Management in the Spain?"
            description="Contractor management helps you engage freelancers and independent contractors compliantly under Spain (Local) law without the complexity of setting up an entity or risking misclassification."
            align="left"
          />
            ...
            <div className="contractor-card">
              ...
              <div className="contractor-card-content">
                ...
                <p className="contractor-card-text">
                  Companies hiring freelancers, consultants, or project-based contractors in the Spain without a local entity. Ideal for tech, consulting, and creative industries.
                </p>
              </div>
            </div>
            <div className="contractor-card">
          ...
          <p className="learn-more-link center-link mt-8">
            <Link href="/spain" >
              Need to hire employees instead? See Spain EOR <ArrowRight className="arrow-icon" />
            </Link>
          </p>
        </div>
      </SlideIn>
        ...
        <div className="container relative-z10">
          <div className="max-w-4xl">
            ...
            <h2 className="section-title text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-5 leading-tight">
              Mastering Contractor Classification for Business Expansion in the Spain
            </h2>

            <div className="text-content">
              <p className="section-desc left-align">
                Unleash your business potential in the Spain with strategic hiring. Learn the intricacies of classifying independent contractors to sidestep fines and penalties.
              </p>
              <p className="section-desc left-align">
                Jackson and Frank provide expert guidance tailored to the Spain (Local) classification landscape, ensuring compliance and success in this dynamic market.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="two-col-grid">
            <div className="image-wrapper order-mobile-2">
              <Image
                ...
                alt="Seamless Contractor Onboarding in the Spain"
            ...
            <div className="text-wrapper order-mobile-1">
              <h2 className="section-title left-align">
                Seamless Contractor Onboarding in the Spain with Jackson and Frank
              </h2>
              <p className="section-desc left-align">
                Simplify the onboarding of independent contractors in the Spain using your Jackson and Frank account. Achieve compliance with local regulations in minutes.
              </p>
              <p className="section-desc left-align">
                Our platform handles everything, from personalized contracts to effortless tax document collection, extending to streamlined international payroll. Make contractor onboarding a breeze for success in the Spain (Local) market with Jackson and Frank.
              </p>
            </div>
          </div>
        </div>
...
<SlideIn as="section" direction="fade-up" className="section">
        <div className="container">
          <div className="two-col-grid">
            <div>
              <h2 className="section-title left-align">
                Upholding Compliance with the Spain&apos; Premier Legal Firms at Jackson and Frank
              </h2>
              <p className="section-desc left-align">
                Trust Jackson and Frank in the Spain to ensure compliance with the expertise of the country&apos;s top legal firms. Our contracts undergo meticulous review, aligning with local laws, covering essentials such as minimum wage, national holidays, and termination conditions.
              </p>
              <p className="section-desc left-align">
                Stay confident with accurate and up-to-date information for seamless operations in the Spain (Local) business landscape.
              </p>
            </div>
...
<SlideIn as="section" direction="zoom-in" className="section eor-section-bg">
        <div className="container">
          <div className="two-col-grid">
            ...
            <div className="text-wrapper order-mobile-1">
              <h2 className="section-title left-align">
                Streamlined Payroll Funding in the Spain - One Click Away with Jackson and Frank
              </h2>
              <p className="section-desc left-align">
                Simplify your payroll process in the Spain with Jackson and Frank. Effortlessly initiate mass payouts in various currencies using your preferred payment method.
              </p>
              <p className="section-desc left-align">
                Team members can conveniently withdraw funds with their chosen payment methods, saving on currency conversions and wire transfer fees. Experience a seamless financial transaction solution tailored for success in the Spain (Local) market.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Why Spain contractor management */}
      <div className="home-content-scale">
<SlideIn as="section" direction="fade-right" className="section">
        <div className="container">
          <div className="max-w-4xl">
            ...
            <h2 className="section-title left-align">
              Why use contractor management in the Spain?
            </h2>
            <div className="text-content">
              <p className="section-desc left-align">
                The Spain has strict rules on contractor classification. The Spain (Local) tax authority (Belastingdienst) actively enforces rules against &quot;schijnzelfstandigheid&quot; (false self-employment). Misclassifying an employee as a contractor can lead to back taxes, social security liabilities, and penalties.
              </p>
              <p className="section-desc left-align">
                Using a contractor management solution like Jackson & Frank helps you engage contractors compliantly: we assess classification, provide Spain (Local)-law contracts (including modelovereenkomsten), handle payroll and invoicing, and monitor ongoing compliance. If a role becomes permanent, we can convert contractors to employees via our Spain EOR.
              </p>
              <p className="section-desc left-align">
                This protects your business, keeps contractors happy with proper agreements and timely payments, and gives you flexibility to scale your Spain (Local) workforce without setting up a local entity.
              </p>
            </div>
          </div>
        </div>
...
<SlideIn as="section" direction="fade-up" className="section">
        <div className="container">
          <SectionTitle
            ...
            description="Weigh the benefits and considerations before engaging contractors in the Spain."
            align="center"
          />
...
<SlideIn as="section" direction="zoom-in" className="section eor-section-bg">
        <div className="container">
          <SectionTitle
            title="Spain (Local) Contractor Compliance"
            description="Staying compliant with Spain (Local) contractor law protects your business from penalties and ensures genuine contractor relationships."
            align="center"
          />
...
<SlideIn as="section" direction="fade-right" className="section">
        <div className="container">
          <div className="center-btn-wrapper mt-8">
            <p className="section-desc center-align">Need to hire full employees in the Spain?</p>
            
              <Link href="/spain" className="btn-primary">Learn more about Spain EOR <ArrowRight className="arrow-icon" /></Link>
