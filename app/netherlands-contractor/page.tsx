        ...
        <div className="container">
          ...
          <p className="learn-more-link center-link mt-8">
            <Link href="/netherlands" >
              Need to hire employees instead? See Netherlands EOR <ArrowRight className="arrow-icon" />
            </Link>
          </p>
        </div>
      </SlideIn>
...
<SlideIn as="section" direction="fade-right" className="section">
        <div className="container">
          <div className="center-btn-wrapper mt-8">
            <p className="section-desc center-align">Need to hire full employees in the Netherlands?</p>
            
              <Link href="/netherlands" className="btn-primary">Learn more about Netherlands EOR <ArrowRight className="arrow-icon" /></Link>
