...
const countryFacts = [
  { label: 'Capital', value: 'Hong Kong', icon: MapPin, iconColor: 'fact-icon-blue' },
  { label: 'Currency', value: 'Hong Kong dollar (HKD)', icon: DollarSign, iconColor: 'fact-icon-green' },
  { label: 'Languages', value: 'Cantonese, English', icon: Languages, iconColor: 'fact-icon-purple' },
  { label: 'Population', value: '7.5M+', icon: Users, iconColor: 'fact-icon-orange' },
  ...
  { label: 'VAT / sales tax', value: 'No VAT', icon: Percent, iconColor: 'fact-icon-red' },
  { label: 'Timezone', value: 'GMT+8 (HKT)', icon: Clock, iconColor: 'fact-icon-cyan' },
]
...
const eorPros = [
  ...
  'One partner for Hong Kong alongside hiring in 17+ other countries.',
]
...
const hongKongEorCaseStudies = [
  {
    slug: 'professional-services-global-hr-transformation',
    title: 'Global HR Transformation for Professional Services Group',
    client: 'Multinational Advisory Firm',
    excerpt: 'Consolidated payroll and employment management across 12 countries into a unified EOR framework.',
    metrics: [
      { value: '12', label: 'Countries consolidated' },
      { value: '45%', label: 'HR admin overhead reduced' },
      { value: '100%', label: 'Compliance across jurisdictions' },
    ],
  },
]
...
export default function HongKongPage() {
  ...
  return (
    <div className="hong-kong-page">
      ...
      <div className="home-content-scale">
        <SlideIn as="section" direction="zoom-in" className="section country-facts-section">
          <div className="container">
            <h2 className="section-title">Hong Kong at a glance</h2>
            <p className="section-desc">
              The Hong Kong is one of Europe's most competitive economies and a gateway to EU talent. With strong employment laws, high English proficiency, and a business-friendly environment, it is a top choice for Employer of Record and Hong Kong payroll outsourcing.
            </p>
      ...
      {/* 3. What is EOR in the Hong Kong */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-right" className="section eor-section-bg">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">What is Employer of Record (EOR) in the Hong Kong?</h2>
              <p className="section-desc left-align">
                Employer of Record Hong Kong lets you hire Hong Kong (Local) employees without setting up a local entity. We become the legal employer; you keep day-to-day control. Ideal for companies that want to hire employees in the Hong Kong without entity setup.
              </p>
            </div>
            <div className="eor-cards-wrapper">
              {/* Who needs Hong Kong EOR? */}
              <div className="eor-card">
                ...
                <div className="eor-card-content">
                  <div className="eor-card-header">
                    ...
                    <h3>Who needs Hong Kong EOR?</h3>
                  </div>
                  <p>
                    US, UK, EU, and global companies hiring in the Hong Kong; startups and scaleups building a Hong Kong (Local) team; enterprises expanding without new entities; HR leaders and recruiters who need fast, compliant hiring.
                  </p>
                </div>
              </div>
              {/* Benefits */}
      ...
      {/* 4. Why the Hong Kong is attractive for hiring */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-left" className="section why-hong-kong-section">
          <div className="container">
            <div className="why-header">
              <div className="subtitle-with-icon">
                <Globe className="globe-icon" />
                <span>Why the Hong Kong?</span>
              </div>
              <div className="orange-line"></div>
            </div>
            <h2 className="section-title left-align">
              Why the Hong Kong is an attractive option for hiring
            </h2>
            <div className="text-content">
              <p>
                The Hong Kong offers an exceptional business environment with a highly educated, multilingual workforce and a strong culture of innovation. As one of Europe's most open economies, it provides excellent access to EU markets and is a leading hub for tech, logistics, and finance. Hong Kong (Local) employment laws 2026 and a clear regulatory framework make Hong Kong EOR and Hong Kong payroll outsourcing straightforward for international companies.
              </p>
              <p>
                English is widely spoken, and the country ranks among the top globally for quality of life and work-life balance. With Europe's largest port in Rotterdam and a strategic location, the Hong Kong is ideal for companies hiring in the Hong Kong without entity: you get local contracts, full compliance with Hong Kong (Local) employment laws, and access to top talent through Employer of Record Hong Kong services.
              </p>
              <p>
                Hong Kong (Local) workers are known for high productivity, technical skills, and a collaborative mindset. The government supports innovation and the Highly Skilled Migrant program makes it easier to bring in non-EU talent. Whether you need Hong Kong payroll outsourcing, full EOR, or visa support, the Hong Kong is a prime destination for scaling your European team.
              </p>
            </div>
          </div>
        </SlideIn>
      ...
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-up" className="section employee-benefits-section">
          <div className="container">
            <h2 className="section-title center-align">Employee benefits in the Hong Kong</h2>
            <p className="section-desc center-align">
              We manage mandatory and optional benefits for your Hong Kong (Local) employees through our Hong Kong EOR and payroll platform. Full compliance with Hong Kong (Local) employment laws 2026, including holiday allowance, pension, and social security.
            </p>
      ...
      {/* 6. Hong Kong Employment Laws 2026 */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="zoom-in" className="section employment-laws-section eor-section-bg">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">Hong Kong Employment Laws 2026: What Companies Must Know</h2>
              <p className="section-desc left-align">
                Stay compliant with Hong Kong (Local) employment law. Key rules on contracts, probation, notice, minimum wage, and employee protections.
              </p>
            </div>
            ...
            <p className="disclaimer-text">
              Non-compliance can lead to fines, back payments, and reputational risk. With Hong Kong EOR, Jackson & Frank ensures your hires meet Hong Kong (Local) employment laws 2026.
            </p>
          </div>
        </SlideIn>
      </div>

      {/* 7. Pros and Cons of Hong Kong EOR */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-right" className="section pros-cons-section">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">Pros and cons of Hong Kong EOR</h2>
              <p className="section-desc left-align">
                Weigh the benefits and considerations of using an Employer of Record in the Hong Kong versus setting up your own entity.
              </p>
            </div>
      ...
      {/* 8. Why Choose Jackson & Frank Hong Kong EOR */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-left" className="section why-choose-section">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">Why Choose Jackson & Frank for Hong Kong EOR?</h2>
              <p className="section-desc left-align">
            ...
            <div className="why-choose-grid">
              {[
                ...
                { icon: Scale, title: 'Full compliance', desc: 'Hong Kong (Local) entity, CAO awareness, and employment law compliance built in.' },
                { icon: Users, title: 'Local expertise', desc: 'Dedicated knowledge of Hong Kong (Local) payroll, benefits, and HR practices.' },
                { icon: Shield, title: 'Risk managed', desc: 'We carry employment and tax risk as the legal employer in the Hong Kong.' },
              ].map((item) => {
      ...
      {/* 5. Jackson & Frank vs Other Hong Kong EOR Providers */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-up" className="section vs-section eor-section-bg">
          <div className="container">
            <div className="section-header center-align">
              <h2 className="section-title center-align">Jackson & Frank vs Other Hong Kong EOR Providers</h2>
              <p className="section-desc center-align">
                Compare speed, compliance, support, and pricing. We focus on European markets with a strong Hong Kong footprint.
              </p>
            </div>
      ...
      {/* 6. Complete Hong Kong Employment Services */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="zoom-in" className="section services-section">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">Our Complete Hong Kong Employment Services</h2>
              <p className="section-desc left-align">
                End-to-end employment and payroll so you can hire and manage Hong Kong (Local) talent without a local entity.
              </p>
            </div>
      ...
      {/* 7. Hong Kong EOR + Immigration */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-right" className="section immigration-section eor-section-bg">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">Hong Kong EOR + Immigration Services</h2>
              <p className="section-desc left-align">
                Visa sponsorship and relocation support so you can hire non-EU talent in the Hong Kong.
              </p>
            </div>
            <div className="immigration-cards">
              <div className="imm-card">
                <h3>Visa sponsorship</h3>
                <p>We support combined residence and work permits (GVVA) and coordinate with the IND so your employees can work legally in the Hong Kong.</p>
              </div>
              <div className="imm-card">
                <h3>Highly Skilled Migrant (HSM) program</h3>
                <p>Fast-track permits and reduced salary thresholds for qualified professionals. We handle sponsorship and paperwork as your Hong Kong EOR.</p>
              </div>
              <div className="imm-card">
                <h3>Relocation support</h3>
                <p>From registration to BSN and first payroll: we guide your new hires through the Hong Kong (Local) system so they can start quickly.</p>
              </div>
            </div>
      ...
      {/* 8. How Our Hong Kong EOR Process Works */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-left" className="section process-section">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">How Our Hong Kong EOR Process Works (2–3 Days)</h2>
              <p className="section-desc left-align">
      ...
      {/* 9. Hong Kong Payroll: What We Handle */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-up" className="section payroll-handles-section eor-section-bg">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">Hong Kong Payroll: What We Handle</h2>
              <p className="section-desc left-align">
                Full payroll and tax compliance so you don't have to manage Hong Kong (Local) regulations.
              </p>
            </div>
        ...
        <SlideIn as="section" direction="zoom-in" className="section platform-section">
          <div className="container">
            <div className="section-header center-align">
              ...
              <p className="section-desc center-align">
                Manage your Hong Kong team from one place.
              </p>
            </div>
        ...
        <SlideIn as="section" direction="fade-right" className="section compliance-section eor-section-bg">
          <div className="container">
            <div className="section-header">
              ...
              <p className="section-desc left-align">
                We keep your Hong Kong hiring legally sound and audit-ready.
              </p>
            </div>
            <div className="compliance-grid">
              {[
                { title: 'Legal compliance', desc: 'Hong Kong (Local) employment law, CAO, UWV, and tax office requirements.' },
      ...
      {/* 12. Hong Kong EOR Success Stories */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-left" className="section success-stories-section">
          <div className="container">
            <div className="section-header center-align">
              <h2 className="section-title center-align">Hong Kong EOR Success Stories</h2>
              <p className="section-desc center-align">
                Real results from companies using our Employer of Record in the Hong Kong.
              </p>
            </div>
            <div className="success-grid">
              {hongKongEorCaseStudies.map((c, index) => (
      ...
      {/* 13. EOR vs Entity Setup in Hong Kong */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-up" className="section entity-vs-eor-section eor-section-bg">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">EOR vs Entity Setup in the Hong Kong</h2>
              <p className="section-desc left-align">
                Decide whether Hong Kong EOR or a Hong Kong (Local) BV is right for you.
              </p>
            </div>
            <div className="table-wrapper">
              <table className="comparison-table small-table">
                <thead>
                  <tr>
                    <th>Aspect</th>
                    <th className="text-primary">Hong Kong EOR</th>
                    <th className="text-gray">Hong Kong (Local) entity (BV)</th>
                  </tr>
                </thead>
                <tbody>
                  {eorVsEntity.map((row) => (
        ...
        <SlideIn as="section" direction="zoom-in" className="section startups-enterprise-section">
          <div className="container">
            <div className="section-header">
              ...
              <p className="section-desc left-align">
                Whether you're a startup or enterprise, Hong Kong EOR fits your use case.
              </p>
            </div>
      ...
      {/* 15. Contractor Management in Hong Kong */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-right" className="section contractor-section eor-section-bg">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">Contractor Management in the Hong Kong</h2>
              <p className="section-desc left-align">
                Avoid misclassification and stay compliant when engaging Hong Kong (Local) contractors.
              </p>
            </div>
            <div className="contractor-box">
              <p className="contractor-intro">
                Hong Kong (Local) rules on self-employed vs employed are strict. Misclassifying workers can lead to back taxes, penalties, and reclassification. We help you:
              </p>
              <ul className="contractor-list">
                ...
                <li>
                  <CheckCircle2 className="list-icon" />
                  Convert contractors to employees via Hong Kong EOR when a permanent role makes more sense.
                </li>
              </ul>
      ...
      {/* Comprehensive Guide to Hiring in the Hong Kong (tabs) */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="fade-left" className="section guide-section eor-section-bg">
          <div className="container">
            <h2 className="section-title left-align">
              Our comprehensive guide to hiring in the Hong Kong
            </h2>
            <p className="section-desc left-align">
              Explore leave, termination, public holidays, onboarding, and immigration. Everything you need for Hong Kong (Local) employment laws 2026 and Hong Kong payroll outsourcing.
            </p>
            ...
            <div className="tab-content">
              {activeTab === 'leave' && (
                <div className="tab-pane">
                  <div className="tab-section">
                    <h3>Annual leave</h3>
                    <p>In the Hong Kong, employees are entitled to a minimum of 20 days (4 weeks) of paid annual leave per year based on full-time employment. Many employers offer 25 days or more. Unused vacation days can usually be carried forward but must be used within six months after the end of the calendar year. Our Hong Kong EOR ensures your team receives full statutory and contractual leave under Hong Kong (Local) employment laws 2026.</p>
                  </div>
                  <div className="tab-section">
                    <h3>Maternity leave</h3>
                    <p>Expecting mothers are entitled to 16 weeks of maternity leave (6 weeks before and 10 weeks after the due date). Salary is paid at 100% by the Hong Kong (Local) Employee Insurance Agency (UWV). Additional unpaid parental leave is available. We handle all administration and compliance for your Hong Kong (Local) employees.</p>
                  </div>
                  <div className="tab-section">
                  ...
                  <div className="tab-section">
                    <h3>Sick leave</h3>
                    <p>Employers must continue to pay sick employees for up to 2 years (minimum 70% of salary, often 100% in year one and 70% in year two as per contract). Hong Kong payroll outsourcing through Jackson & Frank includes correct sick pay and UWV reporting.</p>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'holidays' && (
                <div className="tab-pane">
                  <h3>Public holidays in the Hong Kong 2026</h3>
                  <p className="mb-4">Below are the main national public holidays. Employers are not always required to give paid time off for every holiday it depends on the sector and collective agreement (CAO). Our Hong Kong EOR team applies the correct rules for your employees.</p>
              ...
              {activeTab === 'onboarding' && (
                <div className="tab-pane">
                  <div className="tab-section">
                    ...
                    <p>With Jackson & Frank Hong Kong EOR, onboarding typically takes 2–3 business days. We handle registration with the Hong Kong (Local) tax authority, BSN for foreign workers, and payroll setup. No Hong Kong (Local) entity required you send employee details and signed agreements; we issue the Hong Kong (Local) contract and get them live on Hong Kong payroll.</p>
                  </div>
                  <div className="tab-section">
                    <h3>Salary and holiday allowance</h3>
                    <p>Employers must pay at least the statutory minimum wage and an 8% holiday allowance (typically paid in May). Salaries are usually paid monthly with detailed payslips. Hong Kong payroll outsourcing through us includes all withholdings, social security, and filings.</p>
                  </div>
                  <div className="tab-section">
                    <h3>Employment contract</h3>
                    <p>Hong Kong (Local) contracts must be in writing and include:</p>
                    <ul>
                  ...
                  <div className="tab-section">
                    ...
                    <p>Maximum 1 month for contracts under 2 years; 2 months for contracts of 2+ years or permanent. During probation, either party can terminate without notice. We draft compliant contracts as part of our Employer of Record Hong Kong service.</p>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'additional' && (
                <div className="tab-pane">
                  <h3>Hong Kong (Local) work permits and visas</h3>
                  <p className="mb-3">Non-EU/EEA nationals need a combined residence and work permit (GVVA) or qualify under the Highly Skilled Migrant (HSM) program. Jackson & Frank supports visa sponsorship and relocation: we coordinate with the IND (Immigration and Naturalisation Service), handle sponsorship as your Hong Kong EOR, and guide employees through BSN registration and first payroll.</p>
                  <p>Our in-house team manages the full visa and permit process so you can hire employees in the Hong Kong without entity and without worrying about immigration compliance. Ideal for tech, finance, and scaleups bringing international talent to Amsterdam, Rotterdam, or elsewhere in the Hong Kong.</p>
                </div>
              )}
            </div>
          </div>
      ...
      {/* 16. Hong Kong Employment Statistics 2026 */}
      <div className="home-content-scale">
        <SlideIn as="section" direction="zoom-in" className="section stats-section eor-section-bg">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title left-align">Hong Kong Employment Statistics 2026</h2>
              <p className="section-desc left-align">
                Hiring trends, salary benchmarks, and market insights for planning your Hong Kong (Local) team.
              </p>
            </div>
            ...
            <p className="stats-footer">
              Hong Kong (Local) labor market remains competitive for tech, finance, and logistics. Hong Kong EOR helps you access talent quickly while staying compliant with Hong Kong (Local) employment laws 2026 and payroll obligations.
            </p>
          </div>
        </SlideIn>
      </div>
